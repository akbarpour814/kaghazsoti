...
Comment comment = Comment(
  ...
  text:
      'دکتر یووال نوح هراری از دانشگاه آکسفورد دکترای تاریخ دارد و در حال حاضر در دانشگاه عبری اورشلیم تاریخ جهان تدریس می کند. دو کتاب پرفروش بین المللی  انسان خردمند تاریخ مختصر بشر و انسان خداگونه تاریخ مختصر آینده از او است. کنفرانس پرسش و پاسخی با موضوع آیا ما در سال 2050 بی مصرف خواهیم بود؟ با دکتر یووال نوح هراری در سال 2018  برگزار شد.',
  status: CommentStatus.waiting,
  data: DateTime.now(),
  response:
      'اگر مردی عاشق شما باشد، مایل است به همه بگوید:« این خانم آینده ی من است» یا « این زن دلخواه من است» یا « این بانوی رؤیاهای من است.» به عبارت دیگر، برای شما عنوان یا لقبی انتخاب می کند، که البته از حالت اشاره های معمولی به دور است، مثلاً بگوید: « این همکار یا دوستم است.» لقب های قبلی نشان می دهد که شما در گوشه ای از قلبش جای گرفته اید. یعنی اینکه آن مرد واقعا از صمیم قلبش نسبت به شما احساس محبت می کند و به همین دلیل لقب همسر آینده یا زن دلخواه را برای تان برمی گزیند. این عنوان و نحوه ی بیانش به همگان نشان می دهد که او با افتخار از شما یاد می کند و برنامه ای جدی برای زندگی مشترک با شما در ذهن خود دارد.',
);
