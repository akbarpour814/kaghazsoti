...
import 'package:kaz_reader/pages/audiobook/queue_state.dart';
...
import 'progress_bar/custom_progress_bar.dart';
...
class AudiobookPlayerPage extends StatefulWidget {
  late BookIntroductionModel audiobook;
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(CupertinoPageRoute(
          builder: (context) {
            return BookPage(book: widget.audiobook);
          },
        ));
      },
      child: Container(
