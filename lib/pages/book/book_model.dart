...
class BookModel {
  ...
  late List<BookIntroductionModel> otherBooksByThePublisher;
  late List<BookIntroductionModel> relatedBooks;
  ...
  void setRelatedBooks(List<dynamic> relatedBooksAsMap) {
    for (Map<String, dynamic> book in relatedBooksAsMap) {
      relatedBooks.add(BookIntroductionModel.fromJson(book));
    }
  }
  ...
  void setOtherBooksByThePublisher(
    ...
    for (Map<String, dynamic> book in otherBooksByThePublisherAsMap) {
      otherBooksByThePublisher.add(BookIntroductionModel.fromJson(book));
    }
  }
}
